...
export const integrationConfigs = {
  ...
  [INTEGRATION_CATEGORIES.COMMUNICATIONS]: {
    id: INTEGRATION_CATEGORIES.COMMUNICATIONS,
    name: 'Communications',
    icon: 'radio-tower',
    description: 'SMS, Voice, and generalized communication integrations.',
    providers: [
      {
        id: 'telnyx',
        name: 'Telnyx',
        icon: 'message-square',
        description: 'Global connectivity for voice, messaging, and more.',
        fields: [
          { name: 'label', label: 'Connection Label', type: 'text', required: true, default: 'Telnyx' },
          { name: 'apiKey', label: 'API Key', type: 'password', required: true },
          { name: 'publicApiKey', label: 'Public Key', type: 'text' },
      ...
      },
      {
        ...
        name: 'Twilio',
        icon: 'message-square',
        description: 'Customer engagement platform for SMS, Voice & WhatsApp.',
        fields: [
          { name: 'label', label: 'Connection Label', type: 'text', required: true, default: 'Twilio' },
      ...
      },
      {
        ...
        name: 'Plivo',
        icon: 'message-square',
        description: 'Cloud communications platform for voice and SMS automation.',
        fields: [
          { name: 'label', label: 'Connection Label', type: 'text', required: true, default: 'Plivo' },
      ...
      },
      {
        ...
        name: 'SMS Everywhere',
        icon: 'message-square',
        description: 'Omnichannel communication for SMS text campaigns.',
        fields: [
          { name: 'label', label: 'Connection Label', type: 'text', required: true, default: 'SMS Everywhere' },
          { name: 'apiKey', label: 'API Key', type: 'password', required: true },
