      ...
      <ModuleHeader
        ...
        toolbarLeftSlot={(
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
            <span className="rounded-full border border-[var(--color-border)] bg-[var(--color-bg-primary)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--color-text-secondary)]">
            ...
            <select
              ...
              className="rounded-full border border-[var(--color-border)] bg-[var(--color-bg-primary)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--color-text-secondary)] focus:border-[var(--color-primary)] focus:outline-none"
            >
        ...
        toolbarCenterSlot={(
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              placeholder="Search jobs, assets, and artifacts"
