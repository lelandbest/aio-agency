...
AGENT_DEFINITIONS: Dict[str, AgentDefinition] = {
    ...
    "BRAVO": _definition(
        ...
        allowed_actions=["business_analysis", "market_research", "swot_analysis", "planning"],
    ...
    "CHARLIE": _definition(
        ...
        allowed_actions=["customer_support", "support_ticket", "faq", "add_crm_note", "reply"],
    ...
    "DELTA": _definition(
        ...
        allowed_actions=["project_management", "schedule_calendar", "schedule_meeting", "coordination"],
    ...
    "ECHO": _definition(
        ...
        allowed_actions=["draft_email", "communication_plan", "newsletter", "social_media", "summarize", "reply", "rewrite"],
    ...
    "FORGE": _definition(
        ...
        allowed_actions=["copywriting", "draft_article", "article_generation", "narrative"],
        disallowed_actions=["send_email", "credential_rotation", "emergency_purge"],
    ...
    "GHOST": _definition(
        ...
        allowed_actions=["coding", "code_review", "automation", "system_architecture", "api_integration_design"],
    ...
    "ARCHER": _definition(
        ...
        allowed_actions=["financial_analysis", "kpi_track", "roi", "reporting"],
        disallowed_actions=["deploy_code", "credential_rotation", "emergency_purge"],
    ...
    "ATLAS": _definition(
        ...
        allowed_actions=["systems_mapping", "deployment_planning", "resource_movement", "coordination"],
        disallowed_actions=["send_email", "credential_rotation", "emergency_purge"],
    ...
    "RANGER": _definition(
        ...
        allowed_actions=["seo_optimization", "seo_audit", "keyword_research", "content_optimization"],
        disallowed_actions=["deploy_code", "credential_rotation", "emergency_purge"],
    ...
    "SCOUT": _definition(
        ...
        allowed_actions=["recruitment", "hiring", "onboarding", "candidate_assessment"],
    ...
    "VECTOR": _definition(
        ...
        allowed_actions=["graphics", "visual_generation", "image_generation", "brand_style"],
        disallowed_actions=["deploy_code", "credential_rotation", "emergency_purge"],
